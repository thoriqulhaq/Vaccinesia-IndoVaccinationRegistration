<?php 
  ...
  if (isset($email) && isset($password)) //when form submitted
  {
    if ($num == 1)
    {
      $_SESSION['hospital_email'] = $_POST['hospital_email']; //write login to server storage
      header('Location:hospital_dashboard.php'); //redirect to main
    }
    else {
        ...
        <div class="row no-gutters">
          ...
          <div class="col-md-7">
            <div class="card-body">
              ...
              <p class="login-card-description">Login as Hospital</p>
              <form method="post">
                  <div class="form-group">
                    <label for="email" class="sr-only">Email</label>
                    <input type="email" name="hospital_email" id="hospital_email" class="form-control" placeholder="Email address">
                  </div>
                  <div class="form-group mb-4">
                    <label for="password" class="sr-only">Password</label>
                    <input type="password" name="hospital_password" id="hospital_password" class="form-control" placeholder="Password">
                  </div>
